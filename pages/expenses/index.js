...
import { columns, tipoGasto } from "./data";
    ...
    const handleSubmitG = async (event) => {
        ...
        if ({}) {
            ...
            try {
                ...
                doc1.text(`Total Gastos: ${parseFloat(latestGastos).toLocaleString("es-ES", {
                    style: "currency",
                    currency: "HNL",
        ...
        <div className="espacio">
            <div className="px-8 bg-white shadow rounded-lg shadow-lg  p-4 box-border h-400 w-800 p-2 border-4 ">
                ...
                <p className="text-sm text-gray-600 mb-6">
                    MODULO DE GASTOS - POR FAVOR LLENAR TODOS LOS CAMPOS NECESARIOS
                </p>
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 gap-y-4 sm:grid-cols-2 md:grid-cols-3">
                        ...
                        <div className="sm:col-span-1">
                            <label htmlFor="n_document" className="block text-sm font-medium leading-6 text-gray-900">
            ...
            <div className="bg-white py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8 sm:text-center md:text-center lg:text-center">
                    <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">INFORME DE GASTOS</p>
                </div>
                <div className="px-8 bg-white shadow rounded-lg shadow-lg  p-4 box-border h-400 w-800 p-2 border-4 ">
                    <p className="text-sm text-gray-600 mb-6">
